...
function swiftionportfolio_upgrade_notice() {
	$message = sprintf( __( 'Twenty Nineteen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'swiftionportfolio' ), $GLOBALS['wp_version'] );
...
function swiftionportfolio_customize() {
	wp_die(
		sprintf(
			__( 'Twenty Nineteen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'swiftionportfolio' ),
			$GLOBALS['wp_version']
		),
		'',
		array(
...
function swiftionportfolio_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Twenty Nineteen requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'swiftionportfolio' ), $GLOBALS['wp_version'] ) );
	}
}
